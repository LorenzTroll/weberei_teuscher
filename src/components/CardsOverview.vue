<script setup>
import CardImage from '../assets/images/wt_image_mechanischer-webstuhl_desktop.png'
  ...
  <div class="wrapper">
    ...
    <div class="column">
      ...
      >
        ...
        <p>
          Räumlichkeiten inklusive Maschinen können gemietet werden. Das
          Spektrum reicht von individuellen Projekten bis zu Kursangeboten.
          Einweisung ist verpflichtend und weitere Expertise zusätzlich buchbar.
        </p>
        <!--<button class="button-filled-white">Anfrage</button>-->
      </div>
      <div class="card" style="height: auto; background-color: #86b49e">
        <div class="image contain">
          <img
            src="../assets/images/wt_image_hand-webstuhl_desktop.jpg"
            alt=""
          />
        </div>
        <h1>Handwebstühle</h1>
        <p>
          Zur Verfügung stehen ein Kontermarschwebstuhl mit Schnelllade und 130
          cm Webbdreite, Jaquard Handwebstuhl „Chemnitzer Grobstich“ mit 416
          Platinen, Webbreite von 40 cm u. 20 Fäden pro cm. Hinzu gesellt sich
          ein kleiner Schaftwebtuhl mit max. 16 Schäften, Schnelllade und 1 m
          Webbreite. Tastenwebstuhl mit 12 Schäften.
        </p>
      </div>
    </div>
